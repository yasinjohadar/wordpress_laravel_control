    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إنشاء منتج جديد</h5>
                </div>
                <div class="ms-auto">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('woocommerce.products.store') }}">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                   name="name" placeholder="اسم المنتج" value="{{ old('name') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                                                <option value="simple" @selected(old('type') === 'simple')>بسيط</option>
                                                <option value="grouped" @selected(old('type') === 'grouped')>مجموعة</option>
                                                <option value="external" @selected(old('type') === 'external')>خارجي</option>
                                                <option value="variable" @selected(old('type') === 'variable')>متغير</option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select class="form-select @error('status') is-invalid @enderror" name="status" required>
                                                ...
                                                <option value="publish" @selected(old('status') === 'publish')>منشور</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <select class="form-select @error('stock_status') is-invalid @enderror" name="stock_status" required>
                                                <option value="instock" @selected(old('stock_status') === 'instock')>متوفر</option>
                                                <option value="outofstock" @selected(old('stock_status') === 'outofstock')>نفد المخزون</option>
                                                <option value="onbackorder" @selected(old('stock_status') === 'onbackorder')>قيد الطلب</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="manage_stock" 
                                                   id="manage_stock" value="1" @checked(old('manage_stock')) 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select @error('tax_status') is-invalid @enderror" name="tax_status" required>
                                                <option value="taxable" @selected(old('tax_status') === 'taxable')>خاضع للضريبة</option>
                                                <option value="shipping" @selected(old('tax_status') === 'shipping')>ضريبة الشحن فقط</option>
                                                <option value="none" @selected(old('tax_status') === 'none')>غير خاضع للضريبة</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="featured" 
                                                   id="featured" value="1" @checked(old('featured'))>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="virtual" 
                                                   id="virtual" value="1" @checked(old('virtual'))>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="downloadable" 
                                                   id="downloadable" value="1" @checked(old('downloadable'))>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select @error('catalog_visibility') is-invalid @enderror" 
                                                ...
                                                <option value="visible" @selected(old('catalog_visibility') === 'visible')>ظاهر</option>
                                                <option value="catalog" @selected(old('catalog_visibility') === 'catalog')>في الكتالوج فقط</option>
                                                <option value="search" @selected(old('catalog_visibility') === 'search')>في البحث فقط</option>
                                                <option value="hidden" @selected(old('catalog_visibility') === 'hidden')>مخفي</option>
                                            </select>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fe fe-save"></i> إنشاء المنتج
                                            </button>
                                        </div>
                                    </div>
                                </div>
