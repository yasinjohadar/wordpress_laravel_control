    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إنشاء عميل جديد</h5>
                </div>
                <div class="ms-auto">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('woocommerce.customers.store') }}">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror" 
                                                   name="last_name" placeholder="الاسم الأخير" value="{{ old('last_name') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.first_name') is-invalid @enderror" 
                                                   name="billing[first_name]" placeholder="الاسم الأول" value="{{ old('billing.first_name') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.last_name') is-invalid @enderror" 
                                                   name="billing[last_name]" placeholder="الاسم الأخير" value="{{ old('billing.last_name') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.company') is-invalid @enderror" 
                                                   name="billing[company]" placeholder="اسم الشركة" value="{{ old('billing.company') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.phone') is-invalid @enderror" 
                                                   name="billing[phone]" placeholder="رقم الهاتف" value="{{ old('billing.phone') }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.address_1') is-invalid @enderror" 
                                                   name="billing[address_1]" placeholder="العنوان الأول" value="{{ old('billing.address_1') }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.address_2') is-invalid @enderror" 
                                                   name="billing[address_2]" placeholder="العنوان الثاني" value="{{ old('billing.address_2') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.city') is-invalid @enderror" 
                                                   name="billing[city]" placeholder="المدينة" value="{{ old('billing.city') }}">
                                            <label>المدينة</label>
                                            @error('billing.city')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.state') is-invalid @enderror" 
                                                   name="billing[state]" placeholder="المنطقة" value="{{ old('billing.state') }}">
                                            <label>المنطقة</label>
                                            @error('billing.state')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.postcode') is-invalid @enderror" 
                                                   name="billing[postcode]" placeholder="الرمز البريدي" value="{{ old('billing.postcode') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('billing.country') is-invalid @enderror" 
                                                   name="billing[country]" placeholder="الدولة" value="{{ old('billing.country', 'SA') }}">
                                            <label>الدولة</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="email" class="form-control @error('billing.email') is-invalid @enderror" 
                                                   name="billing[email]" placeholder="البريد الإلكتروني" value="{{ old('billing.email') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.first_name') is-invalid @enderror" 
                                                   name="shipping[first_name]" placeholder="الاسم الأول" value="{{ old('shipping.first_name') }}">
                                            <label>الاسم الأول</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.last_name') is-invalid @enderror" 
                                                   name="shipping[last_name]" placeholder="الاسم الأخير" value="{{ old('shipping.last_name') }}">
                                            <label>الاسم الأخير</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.company') is-invalid @enderror" 
                                                   name="shipping[company]" placeholder="اسم الشركة" value="{{ old('shipping.company') }}">
                                            <label>اسم الشركة</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.address_1') is-invalid @enderror" 
                                                   name="shipping[address_1]" placeholder="العنوان الأول" value="{{ old('shipping.address_1') }}">
                                            <label>العنوان الأول</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.address_2') is-invalid @enderror" 
                                                   name="shipping[address_2]" placeholder="العنوان الثاني" value="{{ old('shipping.address_2') }}">
                                            <label>العنوان الثاني</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.city') is-invalid @enderror" 
                                                   name="shipping[city]" placeholder="المدينة" value="{{ old('shipping.city') }}">
                                            <label>المدينة</label>
                                            @error('shipping.city')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.state') is-invalid @enderror" 
                                                   name="shipping[state]" placeholder="المنطقة" value="{{ old('shipping.state') }}">
                                            <label>المنطقة</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.postcode') is-invalid @enderror" 
                                                   name="shipping[postcode]" placeholder="الرمز البريدي" value="{{ old('shipping.postcode') }}">
                                            <label>الرمز البريدي</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('shipping.country') is-invalid @enderror" 
                                                   name="shipping[country]" placeholder="الدولة" value="{{ old('shipping.country', 'SA') }}">
                                            <label>الدولة</label>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fe fe-save"></i> إنشاء العميل
                                            </button>
                                        </div>
                                    </div>
                                </div>
