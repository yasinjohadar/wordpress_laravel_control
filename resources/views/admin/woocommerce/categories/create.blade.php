    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إنشاء فئة جديدة</h5>
                </div>
                <div class="ms-auto">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('woocommerce.categories.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">يستخدم في URL الفئة</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="display" class="form-select">
                                        <option value="default" {{ old('display', 'default') === 'default' ? 'selected' : '' }}>افتراضي</option>
                                        <option value="products" {{ old('display') === 'products' ? 'selected' : '' }}>المنتجات فقط</option>
                                        <option value="subcategories" {{ old('display') === 'subcategories' ? 'selected' : '' }}>الفئات الفرعية فقط</option>
                                        <option value="both" {{ old('display') === 'both' ? 'selected' : '' }}>المنتجات والفئات الفرعية</option>
                                    </select>
                                </div>
